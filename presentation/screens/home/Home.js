...
const GeustHeader = () => {
  return (
    <View style={{ marginTop: 16 }}>
      ...
      >
        {getString.t("hello_there_login_first")}
      </Text>
    </View>
  );
};
...
const AppointmentStatus = ({ appointment }) => {
  ...
  if (!appointment)
    return (
      <View style={{ paddingTop: 16 }}>
        ...
        >
          {getString.t("you_dont_have_appointment")}
        </Text>
      </View>
    );
  ...
  return (
    <View style={{ alignItems: "center", paddingTop: 24 }}>
      ...
      >
        {getString.t("you_have_an_appointment")}
      </Text>
      <Text
        style={{
          ...globalStyles.font,
      ...
      >
        {moment(appointment.start_time).format(
          `dddd, MMMM DD [${getString.t("at")}] HH:mm`
        )}
      </Text>
      ...
      <AppointmentCard
        ...
        image={appointment.worker.image}
        ...
        >
            ...
            <View style={styles.appointmentStatus}>
              <Animated.View entering={FadeIn.duration(600)} exiting={FadeOut}>
                <BorderButton
                  style={styles.margin}
                  text={
                    user ? getString.t("book") : getString.t("login_or_signup")
                  }
                  onPress={() => {
                    user
          ...
          <View style={{ backgroundColor: backgroundColor, minHeight: "100%" }}>
            ...
            <Image
              ...
              source={require("../../../assets/imgs/barber-logo.png")}
            />
            <Spacer space={12} />
            <SafeAreaView />
          </View>
